...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === 'X') {
            //If activePlayer is equal toX the x.png is placed in HTML
        ...
        if (activePlayer === 'X') {
            //If active player is X change is to O
            activePlayer = 'O';
...
if(activePlayer === 'O') {
    ...
    //Returning true is needed for our computersTurn90 function to work
    return true;
}
...
function checkWinConditions() {
    ...
    //X 6,4,2
    else if (arrayIncludes('6X', '4X','2X')) {drawWinLine(10,508,510,90)}
    //X0,4,8
    ...
    //O 6,4,2
    else if (arrayIncludes('6O', '4O','2O')) {drawWinLine(10,508,510,90)}
    //O0,4,8
    else if (arrayIncludes('0O','4O','8O')) {drawWinLine(100,100,520,520)}
    //This condition check for a tie. If none of the above conditions register and 9
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //returned and our else if conditionexecutes the drawWinLine function
...
//This function utilizes html canvas to dra win lines
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            //This condtion adds 10 to the previous end x point
            if (x< x2) { x += 10; }
